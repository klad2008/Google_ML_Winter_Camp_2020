...
def get_model(): 
    net = Unet(input_channels=3, num_classes=2, num_filters=[32, 64, 128, 256, 512], initializers={'w':'he_normal', 'b':'normal'})
    return net
...
if __name__ == "__main__":
    ...
    print(net)
    net = net.cuda()
    ipt = torch.rand(1, 3, 576, 768)
    out = net(ipt, val=False)
    print(out.size())
